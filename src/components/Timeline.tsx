...
const timelineData: TimelineEntry[] = [
  ...
  { year: "2022–25", title: "Key Account Manager – Wholesalers", company: "Intcomex Bolivia", description: "Supported high-pressure commercial operations, customer success workflows, account coordination, sales reporting needs, and client issue resolution in a multinational technology distribution environment. In parallel, built self-directed Python automation projects for data workflows, alerts, dashboards, and reporting-style systems.", status: "completed", color: "#22C55E", icon: "💼" },
  { year: "Now", title: "Operations Automation Specialist", company: "Upwork & Independent Clients", description: "Building Python automation tools, data workflows, API integrations, dashboards, alert systems, websites, and practical internal tools for businesses that need to reduce manual work.", status: "in-progress", color: "#1A73E8", icon: "🚀" },
];
